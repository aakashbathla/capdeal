...
const CardVendor = () => {
  return (
    <div className="card-vendor row mr0">
      <div className="col-2 col-md-5 col-lg-3 px-3">
        <img src={cardVendor1} className="card-vendor_img" alt="card-vendor" />
      </div>
      <div className="col-9 col-md-7 col-lg-9 sm-relative pl-4">
        <div className="">
          <h3>ShriRam Properties</h3>
          <span className="pr-4">
            <img src={BuildingIcon} className="mr-2" />
            <span className="align-middle">64 Projects</span>
          </span>
          <span>
            <img src={ExpIcon} className="mr-2" />
            12 yrs Experience
          </span>
