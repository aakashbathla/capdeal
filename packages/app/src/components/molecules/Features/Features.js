        ...
        <div className="container">
          <div className="row align-items-center m-0">
            ...
            <div className="col">
              ...
              <span className="features_text features_slash">Exclusive<br/>Inventory</span>
            </div>
            <div className="col">
              <img src={CompartiveMarketIcon} alt="compartive-market" className="features_img" />
              <span className="features_text features_slash slash-none">Home Loan<br/>Assistance</span>
            </div>
