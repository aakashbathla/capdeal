    ...
    <div className="col-lg-12">
      <div className="row">
        <div className="col-lg-7 col-md-6 col-sm-12">
          <h2>
            Customer List
            <small className="text-muted">Manage customer</small>
          </h2>
        </div>
          ...
          <table className="table table-hover m-b-0 list">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-2583
                  </span>
                </td>
                <td>
                  <span className="email">
                    <a href="javascript:void(0);" title="">
                      <i className="zmdi zmdi-email m-r-5"></i>{" "}
                      johnsmith@gmail.com
                    </a>
                  </span>
                </td>
                <td>
                  <address>
                    <i className="zmdi zmdi-pin"></i>123 6th St. Melbourne, FL
                    32904
                  </address>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-5689
                  </span>
                </td>
                <td>
                  <span className="email">
                ...
                <td>
                  <address>
                    <i className="zmdi zmdi-pin"></i>44 Shirley Ave. West
                    Chicago, IL 60185
                  </address>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-9513
                  </span>
                </td>
                <td>
                  <span className="email">
              ...
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-1212
                  </span>
                </td>
                <td>
                  <span className="email">
                    <a href="javascript:void(0);" title="">
                      <i className="zmdi zmdi-email m-r-5"></i>timhank@gmail.com
                    </a>
                  </span>
                </td>
                <td>
                  <address>
                    <i className="zmdi zmdi-pin"></i>70 Bowman St. South
                    Windsor, CT 06074
                  </address>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-2323
                  </span>
                </td>
                <td>
                  <span className="email">
                ...
                <td>
                  <address>
                    <i className="zmdi zmdi-pin"></i>514 S. Magnolia St.
                    Orlando, FL 32806
                  </address>
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-1005
                  </span>
                </td>
                <td>
                  <span className="email">
              ...
              <tr>
                ...
                <td>
                  <span className="phone">
                    <i className="zmdi zmdi-phone m-r-10"></i>264-625-9999
                  </span>
                </td>
                <td>
                  <span className="email">
