    ...
    <div className="col-lg-12 developer_form">
      ...
      >
        <Form>
                ...
                <div className="col-sm-12">
                  <div className="form-group">
                    <div className="form-line">
                      <textarea rows="4" name="about" className="form-control no-resize" placeholder="About"></textarea>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="card">
            <div class="header">
              <h2><strong>Major</strong> Projects</h2>
              <button className="btn btn-primary btn-sm float-right">
                Add More Project
              </button>
            </div>
            <div className="body">
              <h3><span>Project 1</span></h3>
              <div className="row clearfix">
                <div className="col-sm-6">
                  <div className="form-group">
                    <Input
